...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `98.5µs` | `88.4µs` |
| [Day 2](./src/bin/02.rs) | `144.7µs` | `253.1µs` |
| [Day 3](./src/bin/03.rs) | `201.8µs` | `255.6µs` |
| [Day 4](./src/bin/04.rs) | `394.4µs` | `65.9µs` |
| [Day 5](./src/bin/05.rs) | `431.5µs` | `537.6µs` |
| [Day 6](./src/bin/06.rs) | `116.3µs` | `656.3ms` |
| [Day 7](./src/bin/07.rs) | `20.5ms` | `5.4s` |
| [Day 8](./src/bin/08.rs) | `442.7µs` | `554.2µs` |
| [Day 9](./src/bin/09.rs) | `6.5ms` | `27.8ms` |
| [Day 10](./src/bin/10.rs) | `886.3µs` | `1.7ms` |
| [Day 11](./src/bin/11.rs) | `37.5ms` | `35.0ms` |
| [Day 12](./src/bin/12.rs) | `9.3ms` | `11.2ms` |
| [Day 13](./src/bin/13.rs) | `122.6µs` | `119.2µs` |
